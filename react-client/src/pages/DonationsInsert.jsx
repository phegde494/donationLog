...
class DonationsInsert extends Component {
    constructor(props) {
        super(props)
    ...
    render() {
        ...
        return (
            <Wrapper>
                ...
                <Button onClick={this.handleIncludeDonation}>Add Donation</Button>
...
export default DonationsInsert